...
export default function Page() {
  ...
  const description = "Transform real-time conversations into structured knowledge — with live AI agents, instant summaries, transcripts, and a powerful post-call workspace.";
  ...
  useGSAP(() => {
    ...
    document.fonts.ready.then(() => {
      const split = new SplitText(headingRef.current!, { type: "lines", wordsClass: "hero-lines" });
      ...
      if (badgeWrapperRef.current) tl.to(badgeWrapperRef.current, { autoAlpha: 1, y: 0, duration: 0.5 }, 0);
      tl.to(split.lines, { filter: "blur(0px)", yPercent: 0, autoAlpha: 1, scale: 1, duration: 0.9, stagger: 0.12 }, 0.1);
      if (paragraphRef.current) tl.to(paragraphRef.current, { autoAlpha: 1, y: 0, duration: 0.5 }, "-=0.55");
  ...
  return (
    <section ref={sectionRef} className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <ul ref={microRef} className="mt-8 flex flex-wrap justify-center gap-6 text-xs font-light tracking-tight text-emerald-100/70">
